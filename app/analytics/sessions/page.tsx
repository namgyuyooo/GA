...
import { ArrowLeftIcon, ChartBarIcon, ClockIcon, DevicePhoneMobileIcon, GlobeAltIcon, SparklesIcon, ArrowPathIcon } from '@heroicons/react/24/outline'
...
export default function SessionsAnalysis() {
  ...
  const fetchLatestInsight = async () => {
    const res = await fetch(`/api/ai-insight?type=sessions&propertyId=464147982`) // propertyId needs to be dynamic
