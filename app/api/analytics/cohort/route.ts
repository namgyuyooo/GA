...
function generateMockCohortData({ utmSource, utmMedium, utmCampaign }: any) {
  ...
  const campaigns = utmCampaign ? [utmCampaign] : ['summer_sale', 'brand_awareness', 'product_launch']
    ...
    data: {
      ...
      analysis: {
        retentionRates: [
          ...
          { week: 2, retention: 0.50, userCount: 500 },
        ...
        engagementPatterns: [
          ...
          { event: 'click', frequency: 'medium', retention_impact: 0.30 }
        ],
        conversionFunnels: [
          { step: 'Landing', users: 1000, conversion_rate: 1.0 },
          { step: 'Product View', users: 750, conversion_rate: 0.75 },
          { step: 'Add to Cart', users: 300, conversion_rate: 0.40 },
          { step: 'Purchase', users: 89, conversion_rate: 0.30 }
        ]
      }
    }
  }
