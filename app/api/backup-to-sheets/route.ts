...
const TABLES = [
    {
        name: 'UtmCampaigns',
        columns: ['id', 'name', 'source', 'medium', 'campaign', 'term', 'content', 'url', 'description', 'status', 'createdAt', 'updatedAt'],
        model: 'utmCampaign',
    },
    {
        name: 'WeeklyReport',
        columns: ['id', 'title', 'startDate', 'endDate', 'totalSessions', 'totalUsers', 'totalConversions', 'avgEngagementRate', 'totalClicks', 'totalImpressions', 'avgCtr', 'avgPosition', 'reportData', 'createdAt', 'updatedAt'],
        model: 'weeklyReport',
    },
    {
        name: 'ScheduledJob',
        columns: ['id', 'name', 'type', 'schedule', 'isActive', 'lastRun', 'nextRun', 'config', 'createdAt', 'updatedAt'],
        model: 'scheduledJob',
    },
    {
        name: 'Setting',
